...
lib.ssMetadata = [
		{name:"Озвученная_карта мал — копия_HTML5 Canvas — копия_atlas_", frames: [[0,0,1279,771]]}
];
...
(lib.setup = function() {
	this.initialize(ss["Озвученная_карта мал — копия_HTML5 Canvas — копия_atlas_"]);
	this.gotoAndStop(0);
...
(lib.Монтажный_кадр_1_Фон = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-2,0,0.1577,0.1819);
...
(lib.Монтажный_кадр_1_Кнопки = function(mode,startPosition,loop) {
	...
	this.voltmetr.setTransform(150.6,101.9,0.1577,0.1964,0,0,0,0.3,0.5);
	new cjs.ButtonHelper(this.voltmetr, 0, 1, 2, false, new lib.Вольтметр_1(), 3);

	this.instance_6 = new lib.Миллиамперметр_1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(90.5,89.1,0.1577,0.1964,0,0,0,1,0.5);
	...
	this.ampermetr.setTransform(25.65,98.4,0.1577,0.1964,0,0,0,1,0.8);
...
// stage content:
(lib.Озвученная_картамалкопия_HTML5Canvasкопия = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.Кнопки.setTransform(100,65.3,1,1,0,0,0,100,65.3);
	this.Кнопки.depth = 0;
	...
	this.Фон.setTransform(98.8,70.1,1,1,0,0,0,98.8,70.1);
	this.Фон.depth = 0;
...
p.nominalBounds = new cjs.Rectangle(98,69.4,102.69999999999999,70.79999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Озвученная_карта мал — копия_HTML5 Canvas — копия_atlas_.png", id:"Озвученная_карта мал — копия_HTML5 Canvas — копия_atlas_"},
		{src:"sounds/Амперметрonlineaudioconvertercom.mp3", id:"Амперметрonlineaudioconvertercom"},
		{src:"sounds/Вольтметр_.mp3", id:"Вольтметр"},
		{src:"sounds/Выключатель_.mp3", id:"Выключатель"},
		{src:"sounds/Выпрямитель_.mp3", id:"Выпрямитель"},
		{src:"sounds/ИсточникПитания_.mp3", id:"ИсточникПитания"},
		{src:"sounds/ЛАТР_.mp3", id:"ЛАТР"},
		{src:"sounds/Миллиамперметр_.mp3", id:"Миллиамперметр"},
		{src:"sounds/Реостат_.mp3", id:"Реостат"},
		{src:"sounds/Соленоид_.mp3", id:"Соленоид"}
	],
	preloads: []
};
